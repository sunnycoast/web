...
$d->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(($this->privates['service_locator.v5YYcZp'] ?? $this->privates['service_locator.v5YYcZp'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array()))));
