...
// Returns the private 'App\Repository\RachunekRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RachunekRepository.php';

return $this->privates['App\Repository\RachunekRepository'] = new \App\Repository\RachunekRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
