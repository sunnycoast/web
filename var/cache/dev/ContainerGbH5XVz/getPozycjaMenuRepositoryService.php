...
// Returns the private 'App\Repository\PozycjaMenuRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PozycjaMenuRepository.php';

return $this->privates['App\Repository\PozycjaMenuRepository'] = new \App\Repository\PozycjaMenuRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
