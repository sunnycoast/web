...
return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->services['security.token_storage'] ?? $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () {
    ...
    yield 1 => ($this->privates['security.user.provider.concrete.user_db'] ?? $this->load('getSecurity_User_Provider_Concrete_UserDbService.php'));
    yield 2 => ($this->privates['security.user.provider.concrete.klient_db'] ?? $this->load('getSecurity_User_Provider_Concrete_KlientDbService.php'));
    yield 3 => ($this->privates['security.user.provider.concrete.osoba_db'] ?? $this->load('getSecurity_User_Provider_Concrete_OsobaDbService.php'));
