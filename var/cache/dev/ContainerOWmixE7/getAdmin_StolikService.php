...
// Returns the public 'admin.stolik' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\StolikAdmin.php';
...
$this->factories['admin.stolik'] = function () {
    $instance = new \App\Admin\StolikAdmin('admin.stolik', 'App\\Entity\\Stolik', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Stolik');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.stolik.template_registry'] ?? $this->load('getAdmin_Stolik_TemplateRegistryService.php')));
...
return $this->factories['admin.stolik']();
