...
// Returns the public 'admin.rola' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\RolaAdmin.php';
...
$this->factories['admin.rola'] = function () {
    $instance = new \App\Admin\RolaAdmin('admin.rola', 'App\\Entity\\Rola', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Rola');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.rola.template_registry'] ?? $this->load('getAdmin_Rola_TemplateRegistryService.php')));
...
return $this->factories['admin.rola']();
