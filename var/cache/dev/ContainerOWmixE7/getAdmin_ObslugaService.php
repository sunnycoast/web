...
// Returns the public 'admin.obsluga' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\ObslugaAdmin.php';
...
$this->factories['admin.obsluga'] = function () {
    $instance = new \App\Admin\ObslugaAdmin('admin.obsluga', 'App\\Entity\\Obsluga', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Obsluga');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.obsluga.template_registry'] ?? $this->load('getAdmin_Obsluga_TemplateRegistryService.php')));
...
return $this->factories['admin.obsluga']();
