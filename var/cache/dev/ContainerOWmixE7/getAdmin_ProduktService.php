...
// Returns the public 'admin.produkt' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\ProduktAdmin.php';
...
$this->factories['admin.produkt'] = function () {
    $instance = new \App\Admin\ProduktAdmin('admin.produkt', 'App\\Entity\\Produkt', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Produkt');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.produkt.template_registry'] ?? $this->load('getAdmin_Produkt_TemplateRegistryService.php')));
...
return $this->factories['admin.produkt']();
