...
// Returns the private 'App\Repository\ProduktRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ProduktRepository.php';

return $this->privates['App\Repository\ProduktRepository'] = new \App\Repository\ProduktRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
