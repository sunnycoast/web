...
// Returns the public 'admin.rachunek' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\RachunekAdmin.php';
...
$this->factories['admin.rachunek'] = function () {
    $instance = new \App\Admin\RachunekAdmin('admin.rachunek', 'App\\Entity\\Rachunek', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Rachunek');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.rachunek.template_registry'] ?? $this->load('getAdmin_Rachunek_TemplateRegistryService.php')));
...
return $this->factories['admin.rachunek']();
