...
// Returns the public 'admin.osoba' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\OsobaAdmin.php';
...
$this->factories['admin.osoba'] = function () {
    $instance = new \App\Admin\OsobaAdmin('admin.osoba', 'App\\Entity\\Osoba', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Osoba');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.osoba.template_registry'] ?? $this->load('getAdmin_Osoba_TemplateRegistryService.php')));
...
return $this->factories['admin.osoba']();
