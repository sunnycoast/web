...
// Returns the private 'App\Repository\SektorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SektorRepository.php';

return $this->privates['App\Repository\SektorRepository'] = new \App\Repository\SektorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
