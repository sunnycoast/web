...
// Returns the private 'App\Repository\StolikRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StolikRepository.php';

return $this->privates['App\Repository\StolikRepository'] = new \App\Repository\StolikRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
