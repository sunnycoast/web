...
// Returns the private 'App\Repository\StalyKlientRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StalyKlientRepository.php';

return $this->privates['App\Repository\StalyKlientRepository'] = new \App\Repository\StalyKlientRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
