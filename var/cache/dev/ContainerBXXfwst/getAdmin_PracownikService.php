...
// Returns the public 'admin.pracownik' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\PracownikAdmin.php';
...
$this->factories['admin.pracownik'] = function () {
    $instance = new \App\Admin\PracownikAdmin('admin.pracownik', 'App\\Entity\\Pracownik', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Pracownik');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.pracownik.template_registry'] ?? $this->load('getAdmin_Pracownik_TemplateRegistryService.php')));
...
return $this->factories['admin.pracownik']();
