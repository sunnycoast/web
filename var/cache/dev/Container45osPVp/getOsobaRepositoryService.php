...
// Returns the private 'App\Repository\OsobaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\OsobaRepository.php';

return $this->privates['App\Repository\OsobaRepository'] = new \App\Repository\OsobaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
