...
// Returns the private 'App\Repository\BlokadaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BlokadaRepository.php';

return $this->privates['App\Repository\BlokadaRepository'] = new \App\Repository\BlokadaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
