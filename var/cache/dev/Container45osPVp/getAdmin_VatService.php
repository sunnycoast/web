...
// Returns the public 'admin.vat' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\VatAdmin.php';
...
$this->factories['admin.vat'] = function () {
    $instance = new \App\Admin\VatAdmin('admin.vat', 'App\\Entity\\VAT', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('VAT');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.vat.template_registry'] ?? $this->load('getAdmin_Vat_TemplateRegistryService.php')));
...
return $this->factories['admin.vat']();
