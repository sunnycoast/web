...
// Returns the private 'App\Repository\RolaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RolaRepository.php';

return $this->privates['App\Repository\RolaRepository'] = new \App\Repository\RolaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
