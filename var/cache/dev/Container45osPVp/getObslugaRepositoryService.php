...
// Returns the private 'App\Repository\ObslugaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ObslugaRepository.php';

return $this->privates['App\Repository\ObslugaRepository'] = new \App\Repository\ObslugaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
