...
// Returns the private 'App\Repository\RezerwacjeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RezerwacjeRepository.php';

return $this->privates['App\Repository\RezerwacjeRepository'] = new \App\Repository\RezerwacjeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
