...
// Returns the public 'admin.blokada' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\BlokadaAdmin.php';
...
$this->factories['admin.blokada'] = function () {
    $instance = new \App\Admin\BlokadaAdmin('admin.blokada', 'App\\Entity\\Blokada', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Blokada');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.blokada.template_registry'] ?? $this->load('getAdmin_Blokada_TemplateRegistryService.php')));
...
return $this->factories['admin.blokada']();
