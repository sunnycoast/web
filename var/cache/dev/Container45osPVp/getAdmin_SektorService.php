...
// Returns the public 'admin.sektor' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\SektorAdmin.php';
...
$this->factories['admin.sektor'] = function () {
    $instance = new \App\Admin\SektorAdmin('admin.sektor', 'App\\Entity\\Sektor', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Sektor');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.sektor.template_registry'] ?? $this->load('getAdmin_Sektor_TemplateRegistryService.php')));
...
return $this->factories['admin.sektor']();
