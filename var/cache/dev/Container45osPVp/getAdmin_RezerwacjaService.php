...
// Returns the public 'admin.rezerwacja' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\RezerwacjaAdmin.php';
...
$this->factories['admin.rezerwacja'] = function () {
    $instance = new \App\Admin\RezerwacjaAdmin('admin.rezerwacja', 'App\\Entity\\Rezerwacje', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Rezerwacje');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.rezerwacja.template_registry'] ?? $this->load('getAdmin_Rezerwacja_TemplateRegistryService.php')));
...
return $this->factories['admin.rezerwacja']();
