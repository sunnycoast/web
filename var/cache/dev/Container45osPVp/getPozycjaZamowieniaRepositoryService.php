...
// Returns the private 'App\Repository\PozycjaZamowieniaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PozycjaZamowieniaRepository.php';

return $this->privates['App\Repository\PozycjaZamowieniaRepository'] = new \App\Repository\PozycjaZamowieniaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
