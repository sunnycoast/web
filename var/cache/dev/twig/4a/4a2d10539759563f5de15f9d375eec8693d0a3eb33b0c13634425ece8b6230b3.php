...
class __TwigTemplate_d583196effaa9e2f692efbf8fe5bf3c7bb62dd882f0fb345989a58e3c819dc73 extends Twig_Template
{
    private $source;
...
<th";
        // line 12
        if (((array_key_exists("is_diff", $context)) ? (_twig_default_filter((isset($context["is_diff"]) || array_key_exists("is_diff", $context) ? $context["is_diff"] : (function () { throw new Twig_Error_Runtime('Variable "is_diff" does not exist.', 12, $this->source); })()), false)) : (false))) {
            echo " class=\"diff\"";
        }
        echo ">";
...
{% block field_compare %}
    ...
    {% endif %}
{% endblock %}
", "@SonataAdmin/CRUD/base_show_field.html.twig", "E:\\Programy\\XAMPP\\htdocs\\ZTW\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\base_show_field.html.twig");
    }
}
