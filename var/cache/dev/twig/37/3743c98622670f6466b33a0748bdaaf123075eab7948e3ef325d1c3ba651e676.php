...
/* test.html.twig */
class __TwigTemplate_c86c103d07979155a818087d412043a3723b3eb5ad483d75e0732f2a854d44db extends Twig_Template
{
    private $source;
    ...
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("Layouts/main.html.twig", "test.html.twig", 1);
        $this->blocks = array(
...
";
    ...
    <table>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new Twig_Error_Runtime('Variable "table" does not exist.', 19, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            echo "</td>
                <td><a href=\"";
            // line 23
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("start");
            echo "\">Edytuj</a> </td>
            </tr>
...
";
    ...
    {
        return array (  112 => 27,  102 => 23,  98 => 22,  94 => 21,  91 => 20,  87 => 19,  77 => 11,  68 => 10,  54 => 4,  45 => 3,  15 => 1,);
    }
    ...
    <table>
        ...
        {% for row in table %}
            <tr>
                ...
                <td><a href=\"{{ url('start') }}\">Edytuj</a> </td>
            </tr>
...
{% endblock %}", "test.html.twig", "D:\\xampp\\htdocs\\ProjektRestauracja\\templates\\test.html.twig");
    }
}
