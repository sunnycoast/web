...
// Returns the public 'admin.kategoria' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\KategoriaAdmin.php';
...
$this->factories['admin.kategoria'] = function () {
    $instance = new \App\Admin\KategoriaAdmin('admin.kategoria', 'App\\Entity\\Kategoria', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('Kategoria');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.kategoria.template_registry'] ?? $this->load('getAdmin_Kategoria_TemplateRegistryService.php')));
...
return $this->factories['admin.kategoria']();
