...
// Returns the public 'admin.staly_klient' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\StalyKlientAdmin.php';
...
$this->factories['admin.staly_klient'] = function () {
    $instance = new \App\Admin\StalyKlientAdmin('admin.staly_klient', 'App\\Entity\\StalyKlient', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('StalyKlient');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.staly_klient.template_registry'] ?? $this->load('getAdmin_StalyKlient_TemplateRegistryService.php')));
...
return $this->factories['admin.staly_klient']();
