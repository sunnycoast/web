...
// Returns the public 'admin.pozycja_zamowienia' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\PozycjaZamowieniaAdmin.php';
...
$this->factories['admin.pozycja_zamowienia'] = function () {
    $instance = new \App\Admin\PozycjaZamowieniaAdmin('admin.pozycja_zamowienia', 'App\\Entity\\PozycjaZamowienia', 'SonataAdminBundle:CRUD');
    ...
    $instance->setLabel('PozycjaZamowienia');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.pozycja_zamowienia.template_registry'] ?? $this->load('getAdmin_PozycjaZamowienia_TemplateRegistryService.php')));
...
return $this->factories['admin.pozycja_zamowienia']();
