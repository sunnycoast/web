...
// Returns the private 'App\Repository\KategoriaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\KategoriaRepository.php';

return $this->privates['App\Repository\KategoriaRepository'] = new \App\Repository\KategoriaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
