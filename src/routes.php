...
$routes->add('staly_klient', new Route( '/{imie}/{nzwisko}', array(
    '_controller' => 'MVC\\Controller\\StalyKlientController::indexAction'
)));

$routes->add('zamowienieSK', new Route( '/{imie}/{nzwisko}/zamowienie', array(
    'imie' => '',
    '_controller' => 'MVC\\Controller\\ZamowienieController::indexAction'
)));

$routes->add('podsumowanieSK', new Route( '/{imie}/{nzwisko}/zamowienie/podsumowanie', array(
    'imie' => '',
    '_controller' => 'MVC\\Controller\\ZamowieniePodsumowanieController::indexAction'
)));

$routes->add('zakonczSK', new Route( '/{imie}/{nzwisko}/zamowienie/podsumowanie/zamkniecie/rachunku', array(
    'imie' => '',
    '_controller' => 'MVC\\Controller\\ZamowienieZakonczController::indexAction'
)));

$routes->add('rezerwacje', new Route( '/{imie}/{nzwisko}/rezerwacje', array(
    '_controller' => 'MVC\\Controller\\RezerwacjeController::indexAction'
)));

$routes->add('rezerwacje_nowa', new Route( '/{imie}/{nzwisko}/rezerwacje/nowa', array(
